...
__all__ = [
    'SPBO_NONE', 'DISPID_SAVolume', 'DISPID_SVGetVoices', 'SPVISEMES',
    'SPEI_SR_BOOKMARK', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpXMLRecoResult', 'SVSFUnusedFlags', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRProfile', 'DISPIDSPRG', 'SVP_3', 'SVSFNLPMask',
    'DISPID_SVAudioOutputStream', 'DISPID_SPRulesItem',
    'DISPID_SRRGetXMLResult', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechWaveFormatEx', 'SpStreamFormatConverter', 'SVP_9',
    ...
    'SDTReplacement', 'SPBO_AHEAD', 'SPEI_FALSE_RECOGNITION',
    'eLEXTYPE_USER_SHORTCUT', 'ISpRecoContext2',
    'ISpeechCustomStream', 'Speech_Max_Word_Length',
    'DISPID_SVEVoiceChange', 'SITooSlow', 'ISpStream',
    'DISPID_SRCAudioInInterferenceStatus', 'SPINTERFERENCE_NONE',
    'ISpeechRecoResult', 'DISPID_SLWLangId', 'DISPID_SVVoice',
    'SRADynamic', 'SAFTADPCM_22kHzStereo', 'DISPID_SRGState',
    'DISPID_SGRSTPropertyValue', 'SVF_Stressed',
    'SPRS_ACTIVE_USER_DELIMITED', 'SVP_21', 'SAFT12kHz8BitMono',
    'ISpRecognizer3', 'SpObjectTokenCategory',
    'eLEXTYPE_LETTERTOSOUND', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SOTGetAttribute', 'DISPID_SVSVisemeId', 'SPRULE',
    'eLEXTYPE_RESERVED8', 'DISPID_SPIAudioStreamPosition',
    'SVEWordBoundary', 'DISPID_SRCCreateResultFromMemory',
    'SVEStartInputStream', 'SBONone', 'DISPID_SLPLangId',
    'SPCT_SUB_DICTATION', 'DISPID_SABIMinNotification',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPEI_SOUND_END',
    'SRSActiveAlways', 'ISpPhoneticAlphabetConverter',
    'SPVPRI_NORMAL', 'DISPID_SPIReplacements',
    'DISPID_SpeechCustomStream', 'DISPID_SpeechVoiceEvent', 'SVP_11',
    'DISPID_SCSBaseStream', 'DISPID_SPEPronunciation',
    ...
    'SAFTCCITT_uLaw_8kHzMono', 'SDTAlternates', 'SPRECOCONTEXTSTATUS',
    'tagSPPROPERTYINFO', 'DISPID_SRRTTickCount',
    'SAFTGSM610_44kHzMono', 'SPSNotOverriden', 'DISPID_SOTsCount',
    'SPFM_NUM_MODES', 'DISPID_SRState', 'SAFT44kHz8BitMono',
    'SpeechWordPronounceable', 'eLEXTYPE_PRIVATE6',
    'DISPID_SPIStartTime', 'SP_VISEME_19', 'SAFT11kHz8BitStereo',
    'SVSFVoiceMask', 'SAFT32kHz16BitMono', 'DISPID_SDKDeleteKey',
    'SpeechVisemeFeature', 'DISPID_SVGetProfiles',
    'DISPID_SVEStreamEnd', 'DISPID_SMSGetData', 'SpSharedRecognizer',
    'DISPID_SRGCmdLoadFromMemory', 'SAFT8kHz16BitMono',
    'DISPID_SDKGetStringValue', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SLPsItem', 'SPPS_Noncontent', 'DISPID_SRCVoice',
    'eWORDTYPE_DELETED', 'SDTProperty', 'SPVPRI_OVER',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpPhoneticAlphabetSelection',
    'SpAudioFormat', 'DISPID_SAStatus',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SpeechAudioStatus',
    'DISPID_SRRAlternates', 'SVEAudioLevel', 'SPCATEGORYTYPE',
    'ISpNotifyTranslator', 'SPDKL_DefaultLocation',
    'ISpeechGrammarRuleStateTransitions', 'SREPropertyStringChange',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRGId', 'SDTAll',
    'ISpObjectToken', 'DISPID_SVEBookmark', 'SAFT48kHz8BitStereo',
    'SPPHRASE', 'SpWaveFormatEx', 'SAFT12kHz16BitStereo',
    'DISPID_SRRTStreamTime', 'ISpeechResourceLoader', 'eLEXTYPE_APP',
    'DISPID_SVEEnginePrivate', 'DISPID_SPEAudioTimeOffset',
    'SpeechVisemeType', 'DISPID_SVSInputWordPosition',
    'SAFT32kHz8BitStereo', 'SPEI_ADAPTATION', 'SLODynamic',
    'DISPID_SPEsCount', 'DISPID_SWFEFormatTag',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRCEventInterests',
    'DISPID_SOTSetId', 'DISPID_SPACommit', 'SPPHRASEPROPERTY',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRAudioInputStream',
    'DISPID_SPIGetDisplayAttributes', 'SRAImport',
    'DISPID_SADefaultFormat', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SVIsUISupported', 'eLEXTYPE_PRIVATE4', 'ISpDataKey',
    'DISPID_SpeechMMSysAudio', 'SPCT_COMMAND', 'SVEViseme',
    'SRAInterpreter', 'SpeechCategoryRecognizers', 'DISPID_SGRSTText',
    'DISPID_SRCEInterference', 'DISPID_SASetState',
    'DISPID_SOTRemove', 'SpeechLoadOption', 'ISpeechAudio',
    'DISPID_SRSCurrentStreamPosition', 'SAFTGSM610_8kHzMono',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRGRules',
    'DISPID_SVESentenceBoundary', 'SRTStandard', 'SRCS_Disabled',
    'DISPID_SGRSTPropertyName', 'SPRECORESULTTIMES', 'SP_VISEME_15',
    'SSFMOpenReadWrite', 'SpeechRuleState',
    'DISPID_SpeechXMLRecoResult', 'IEnumString', 'SVP_10',
    'DISPID_SRSetPropertyString', 'DISPID_SRDisplayUI',
    'SPEI_RESERVED6', 'DISPID_SAFGuid', 'SRARoot', 'SVPOver',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechFileStream',
    'DISPID_SPPBRestorePhraseFromMemory', 'SpMMAudioOut',
    'DISPID_SpeechBaseStream', 'ISpeechDataKey', 'DISPID_SLPPhoneIds',
    'SLOStatic', 'DISPID_SRCEAudioLevel', 'eLEXTYPE_MORPHOLOGY',
    'SDKLCurrentUser', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRGetRecognizers', 'SDA_Two_Trailing_Spaces',
    'SPEI_RESERVED3', 'SRADefaultToActive', 'DISPID_SPPValue',
    'SPRST_INACTIVE', 'DISPID_SDKSetBinaryValue',
    'DISPID_SpeechLexiconProns', 'SPAO_RETAIN_AUDIO',
    'DISPID_SOTs_NewEnum', 'SRTEmulated', 'SP_VISEME_5',
    'DISPID_SRCEEndStream', 'SpeechAllElements', 'ISpObjectWithToken',
    'DISPID_SGRSTRule', 'SAFTGSM610_22kHzMono',
    'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SDKLDefaultLocation', 'DISPID_SPAPhraseInfo',
    'ISpeechPhoneConverter', 'SPPHRASEELEMENT',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SECFIgnoreWidth',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRIsShared',
    'ISpeechObjectTokenCategory', 'SVPAlert', 'DISPID_SPILanguageId',
    'SRSActive', 'DISPID_SRRecognizer', 'DISPID_SVStatus',
    'ISpeechMemoryStream', 'eLEXTYPE_RESERVED6',
    'SpeechPropertyResponseSpeed', 'SpNullPhoneConverter',
    'SpeechRecognizerState', 'DISPID_SPRuleConfidence',
    'DISPID_SRGCmdLoadFromResource', 'SpeechCategoryAudioIn',
    'SPDKL_LocalMachine', 'DISPID_SASState', 'SpCompressedLexicon',
    'SASClosed', 'SPEI_VISEME', 'SWTDeleted', 'SASRun',
    'SpPhraseInfoBuilder', 'SP_VISEME_9',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SVEViseme',
    'SpeechVoiceEvents', 'SDTPronunciation',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpeechAudioStatus',
    'SPEI_INTERFERENCE', 'SpeechLexiconType', 'DISPID_SGRs_NewEnum',
    'SVP_1', 'SAFTCCITT_uLaw_11kHzMono', 'SGDSActive',
    'DISPID_SGRSRule', 'ISpeechGrammarRuleStateTransition',
    'SGLexicalNoSpecialChars', 'ISpeechPhraseAlternates',
    'DISPID_SRCERecognition', 'ISpGrammarBuilder', 'SECLowConfidence',
    'SVSFParseSsml', 'SPFM_OPEN_READONLY',
    'DISPID_SPIRetainedSizeBytes', 'SP_VISEME_0',
    'ISpeechXMLRecoResult', 'SAFTCCITT_uLaw_8kHzStereo', 'SPPS_LMA',
    'SPDKL_CurrentConfig', 'DISPID_SPCIdToPhone', 'SPAS_STOP',
    'DISPID_SRSCurrentStreamNumber', 'SPFM_CREATE_ALWAYS',
    'DISPID_SPCLangId', 'ISpeechPhraseElement',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SBSRead',
    'DISPID_SOTMatchesAttributes',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'STCRemoteServer',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPEAudioSizeTime',
    'SVSFParseMask', 'DISPID_SPRuleParent', 'SAFT8kHz8BitMono',
    'SVP_6', 'SpeechPropertyNormalConfidenceThreshold',
    'SREStreamEnd', 'SGRSTTEpsilon', 'SpUnCompressedLexicon',
    'DISPID_SGRAttributes', 'SRSEIsSpeaking', 'IStream',
    'DISPID_SRRSaveToMemory', '_ISpeechRecoContextEvents',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPRs_NewEnum',
    'eLEXTYPE_PRIVATE14', 'ISpeechPhraseProperties', 'SPEI_MIN_TTS',
    'SPPS_RESERVED3', 'SpeechGrammarTagDictation',
    'SpeechSpecialTransitionType', 'eLEXTYPE_PRIVATE10',
    'SPINTERFERENCE_NOSIGNAL', 'SPEVENT', 'SPEI_START_SR_STREAM',
    'ISpeechMMSysAudio', 'SPBO_PAUSE', 'DISPID_SABufferNotifySize',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVSCurrentStreamNumber', 'SpeechPropertyAdaptationOn',
    'DISPID_SVVolume', 'DISPID_SVWaitUntilDone', 'SP_VISEME_1',
    'DISPID_SGRsItem', 'DISPID_SVSPhonemeId', '_RemotableHandle',
    'DISPID_SPRuleChildren', 'DISPID_SRRRecoContext', 'SGLexical',
    'SpeechDiscardType', 'DISPID_SBSFormat',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVEventInterests',
    'SPCS_DISABLED', 'DISPID_SLWWord', 'SpeechRunState',
    'DISPID_SVSInputWordLength', 'SGSExclusive', 'SPGS_EXCLUSIVE',
    'DISPID_SWFEAvgBytesPerSec', 'STCAll', 'SPSMF_SAPI_PROPERTIES',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_RESERVED7',
    'DISPID_SDKGetlongValue', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVSFParseAutodetect',
    'SPWORDPRONUNCIATIONLIST', 'SVP_2', 'DISPID_SPISaveToMemory',
    'DISPID_SFSOpen', 'SAFTADPCM_11kHzStereo', 'DISPID_SVEPhoneme',
    'SPEI_SR_PRIVATE', 'SAFTExtendedAudioFormat', 'SVEPrivate',
    'SP_VISEME_2', 'DISPID_SPRNumberOfElements', 'SPEI_REQUEST_UI',
    'SP_VISEME_21', 'DISPID_SMSADeviceId', 'SpeechVoicePriority',
    'DISPID_SDKEnumValues', 'SGSDisabled', 'DISPID_SGRsFindRule',
    'DISPID_SRGDictationSetState', 'eLEXTYPE_PRIVATE13',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVP_8', 'SPEI_PHRASE_START',
    'SPEI_HYPOTHESIS', 'eLEXTYPE_PRIVATE18',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SPCPhoneToId',
    'DISPID_SOTCId', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SGRSTransitions', 'Speech_Default_Weight', 'SP_VISEME_10',
    'DISPID_SDKSetStringValue', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPRuleFirstElement', 'DISPID_SpeechAudio',
    'DISPIDSPTSI_SelectionLength', 'SVSFPurgeBeforeSpeak',
    'DISPID_SLGenerationId', 'SPGRAMMARWORDTYPE', 'SSFMOpenForRead',
    'DISPID_SOTGetDescription', 'DISPID_SOTsItem', 'ISpeechLexicon',
    'DISPID_SRCEEnginePrivate', 'DISPID_SpeechRecognizer',
    'SVEAllEvents', 'SECFIgnoreCase', 'DISPID_SGRName',
    'DISPID_SRGReset', 'DISPID_SPIEngineId', 'DISPID_SRGCommit',
    'DISPID_SPRsItem', 'SpeechTokenKeyAttributes', 'SVEBookmark',
    'ISpeechPhraseRules', 'Speech_StreamPos_RealTime',
    'SREFalseRecognition', 'DISPID_SVSRunningState',
    'SECHighConfidence', 'STCInprocHandler',
    'DISPID_SPPNumberOfElements', 'IInternetSecurityManager',
    'ISpeechWaveFormatEx', 'SVP_4', 'DISPID_SPRuleEngineConfidence',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRCCreateGrammar',
    'DISPID_SpeechGrammarRule', 'SVP_20',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRSTsItem',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPPConfidence',
    'DISPID_SpeechPhraseProperty', 'SpResourceManager',
    'DISPID_SRCERecognitionForOtherContext', 'SPLO_STATIC',
    'SPSHT_Unknown', 'eLEXTYPE_PRIVATE2', 'DISPID_SGRsCommitAndSave',
    'SPRS_INACTIVE', 'eLEXTYPE_PRIVATE1', 'SRESoundEnd', 'SPCT_SLEEP',
    'SpeechBookmarkOptions', 'DISPID_SRCEPropertyNumberChange',
    'SpPhoneticAlphabetConverter', 'DISPID_SRGetPropertyNumber',
    'SpeechWordType', 'SPVPRIORITY', 'IInternetSecurityMgrSite',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SOTCSetId', 'ISpeechPhraseAlternate',
    'SpeechTokenShellFolder', 'ISpeechObjectToken',
    'DISPID_SVSInputSentencePosition', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPRuleId', 'SPPS_NotOverriden', 'eLEXTYPE_PRIVATE19',
    'DISPID_SWFEBitsPerSample', 'SRTSMLTimeout',
    'Speech_StreamPos_Asap', 'ISpeechRecognizerStatus',
    'DISPID_SPPId', 'SPPS_RESERVED2', 'SpeechDictationTopicSpelling',
    'SPWAVEFORMATTYPE', 'SpMemoryStream',
    'DISPID_SpeechPhraseElement', 'SP_VISEME_8',
    'SPRST_ACTIVE_ALWAYS', 'SPGRAMMARSTATE', 'SAFTADPCM_11kHzMono',
    'DISPID_SVSpeak', 'DISPID_SAFGetWaveFormatEx',
    '_ISpeechVoiceEvents', 'SVSFlagsAsync', 'DISPID_SPPsItem',
    'SAFTText', 'SRATopLevel', 'DISPID_SLGetWords', 'SINone',
    'DISPID_SpeechPhoneConverter', 'LONG_PTR', 'SAFT48kHz8BitMono',
    'ISpeechPhraseProperty', 'STSF_CommonAppData',
    'DISPID_SpeechPhraseElements', 'ISpeechRecoResultTimes',
    'DISPID_SLWsCount', 'SRTReSent', 'DISPID_SRCState',
    'eLEXTYPE_USER', 'SPAR_Unknown', 'SPPS_Noun',
    'SPEI_RECO_STATE_CHANGE', 'STSF_FlagCreate',
    'DISPID_SPEDisplayAttributes', 'SAFTGSM610_11kHzMono',
    'SPEI_TTS_PRIVATE', 'DISPID_SLAddPronunciation', 'SPLEXICONTYPE',
    ...
    'DISPID_SOTDisplayUI', 'SAFT12kHz8BitStereo',
    'eLEXTYPE_PRIVATE16', 'DISPID_SABufferInfo', 'SPSEMANTICFORMAT',
    'SDA_Consume_Leading_Spaces', 'DISPID_SPPChildren',
    'SpeechStreamFileMode', 'SINoSignal', 'DISPID_SOTCDefault',
    'SPAR_Low', 'SP_VISEME_3', 'SPSHORTCUTPAIR', 'DISPID_SVSkip',
    'SVSFIsXML', 'ISpPhoneConverter', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SPRulesCount', 'SPSHORTCUTTYPE', 'SVSFIsNotXML',
    'ISpEventSink', 'SGRSTTRule', 'SpeechTokenValueCLSID',
    'DISPID_SpeechObjectToken', 'ISpeechAudioBufferInfo',
    'SRERequestUI', 'DISPID_SpeechPhraseReplacement',
    'SAFT11kHz8BitMono', 'SpVoice', 'SAFT24kHz16BitMono',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechMicTraining',
    'SAFTADPCM_44kHzStereo', 'DISPID_SPEDisplayText',
    'DISPID_SPERetainedSizeBytes', 'SpeechEngineConfidence',
    'SAFT24kHz8BitMono', 'SPBOOKMARKOPTIONS',
    'ISpeechPhraseReplacements', 'SpStream', 'DISPID_SMSAMMHandle',
    'SAFT12kHz16BitMono', 'SPPS_RESERVED1', 'SPEI_MAX_SR',
    'ISpPhraseAlt', 'DISPID_SRCEStartStream', 'SREInterference',
    'SRTExtendableParse', 'SASStop', 'DISPID_SpeechVoice',
    'DISPID_SMSALineId', 'DISPID_SpeechLexiconPronunciation',
    'SPPROPERTYINFO', 'SpPhoneConverter', 'DISPID_SOTCategory',
    'SAFT32kHz8BitMono', 'SAFTADPCM_22kHzMono', 'SPEI_MAX_TTS',
    'SPPS_Modifier', 'DISPID_SDKSetLongValue',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPPsCount',
    'DISPID_SDKOpenKey', 'DISPID_SWFESamplesPerSec', 'DISPID_SAFType',
    ...
    'DISPID_SMSSetData', 'SPWORDPRONUNCIATION',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPSFunction',
    'DISPID_SpeechMemoryStream', 'SVP_15', 'SPPS_Unknown',
    'eLEXTYPE_PRIVATE5', 'SPSMF_SRGS_SAPIPROPERTIES', '_SPAUDIOSTATE',
    'DISPID_SRCEHypothesis', 'DISPID_SpeechPhraseBuilder',
    'SRERecoOtherContext', 'SpeechPropertyResourceUsage',
    'SAFT16kHz8BitStereo', 'SPAO_NONE', 'SPSERIALIZEDRESULT',
    'eLEXTYPE_PRIVATE9', 'SPCONTEXTSTATE',
    'SpeechCategoryAppLexicons', 'SpeechStreamSeekPositionType',
    'SpeechAudioFormatGUIDText', 'SPSVerb', 'SPLO_DYNAMIC',
    'DISPID_SRGetFormat', 'SRTAutopause', 'SAFTCCITT_uLaw_44kHzMono',
    'SPLOADOPTIONS', 'SRERecognition', 'DISPID_SRStatus',
    'STCInprocServer', 'DISPID_SPRsCount', 'SpFileStream',
    'DISPID_SBSSeek', 'SP_VISEME_7', 'SPSLMA', 'eLEXTYPE_PRIVATE17',
    'SAFT32kHz16BitStereo', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SVPriority', 'SpeechCategoryRecoProfiles', 'SP_VISEME_13',
    'SPRS_ACTIVE', 'DISPID_SRGDictationUnload', 'SPWT_LEXICAL',
    'DISPID_SGRAddState', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SPERequiredConfidence', 'SVP_5', 'DISPID_SFSClose',
    'DISPID_SABIEventBias', 'DISPID_SRSetPropertyNumber', 'SVF_None',
    'SPEI_VOICE_CHANGE', 'SVEPhoneme', 'SGRSTTDictation',
    'SREStateChange', 'DISPID_SpeechPhraseRules', 'SpObjectToken',
    'SPCT_DICTATION', 'DISPID_SASCurrentSeekPosition',
    'SpeechTokenKeyFiles', 'SLTUser', 'SREPropertyNumChange',
    'eLEXTYPE_RESERVED9', 'SPRULESTATE', 'DISPID_SPIGetText',
    'eLEXTYPE_VENDORLEXICON', 'ISpeechPhraseInfo', 'DISPID_SPEsItem',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpObjectTokenCategory', 'SVP_7',
    'SAFT11kHz16BitMono', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPWT_PRONUNCIATION',
    'IEnumSpObjectTokens', 'SpeechRegistryUserRoot',
    'DISPID_SRGCmdSetRuleIdState', 'SpMMAudioEnum',
    'DISPID_SpeechGrammarRules', 'STSF_LocalAppData', 'SpLexicon',
    'DISPID_SLPs_NewEnum', 'DISPID_SGRSAddRuleTransition',
    'SAFTADPCM_8kHzStereo', 'ISpeechLexiconWords',
    'SPEVENTSOURCEINFO', 'ISpNotifySource',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRCRequestedUIType', 'SECFIgnoreKanaType',
    'DISPID_SRCEBookmark', 'SVSFNLPSpeakPunc', 'SECFDefault',
    'ISpRecoGrammar2', 'SPINTERFERENCE_TOOFAST',
    'Speech_Max_Pron_Length', 'DISPID_SpeechLexicon',
    'SVESentenceBoundary', 'DISPID_SOTCGetDataKey', 'SPPS_Verb',
    'DISPID_SLWPronunciations', 'SpeechTokenContext',
    'DISPID_SPIEnginePrivateData', 'DISPID_SGRSTWeight',
    'DISPID_SAEventHandle', 'SP_VISEME_14', 'SECNormalConfidence',
    'SpeechInterference', 'DISPID_SOTCreateInstance', 'WAVEFORMATEX',
    'DISPID_SPRText', 'SAFT16kHz16BitMono', 'SPCT_SUB_COMMAND',
    'SP_VISEME_4', 'eWORDTYPE_ADDED', 'DISPID_SGRsCommit',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVSFDefault',
    'ISpNotifySink', 'DISPIDSPTSI_SelectionOffset',
    'ISpeechPhraseReplacement', 'DISPID_SRRTOffsetFromStart',
    'SpeechRetainedAudioOptions', 'SASPause',
    'ISpeechLexiconPronunciations', 'ISpeechVoiceStatus',
    'SAFT24kHz16BitStereo', 'SPSEMANTICERRORINFO',
    'DISPID_SGRSAddWordTransition', 'ISpRecoGrammar',
    'SPRECOGNIZERSTATUS', 'SpeechVoiceSpeakFlags', 'SPSSuppressWord',
    'DISPID_SVAudioOutput', 'DISPID_SDKDeleteValue', 'SPAR_High',
    'SREStreamStart', 'SSFMCreateForWrite',
    'SpeechTokenIdUserLexicon', 'DISPID_SWFEExtraData',
    'ISpSerializeState', 'SAFTDefault', 'SAFTCCITT_ALaw_44kHzMono',
    'SECFNoSpecialChars', 'DISPID_SVDisplayUI', 'ISpPhrase',
    'SpNotifyTranslator', 'SAFT24kHz8BitStereo', 'SPSInterjection',
    'DISPID_SVResume', 'SFTInput', 'DISPID_SRSClsidEngine',
    ...
    'SREPhraseStart', 'SGPronounciation', 'SPGS_ENABLED', 'SVPNormal',
    'eLEXTYPE_PRIVATE3', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechRecognitionType', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SOTIsUISupported', 'SpeechAudioVolume',
    'SpeechPartOfSpeech', 'SDTAudio', 'SPRST_NUM_STATES',
    'SPAR_Medium', 'SPEI_RESERVED5', 'SAFT16kHz8BitMono', 'SVP_16',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPIRule',
    'ISpeechTextSelectionInformation', 'DISPID_SRCESoundStart',
    'DISPID_SpeechVoiceStatus', 'SPWORDTYPE', 'SpeechGrammarWordType',
    'SPINTERFERENCE', 'SPSMF_UPS', 'SVSFPersistXML', 'SVEVoiceChange',
    'ISpeechRecoResultDispatch', 'DISPIDSPTSI',
    'DISPID_SRRPhraseInfo', 'SVP_0', 'DISPID_SGRInitialState',
    'DISPID_SPIGrammarId', 'SDKLCurrentConfig',
    'DISPID_SPERetainedStreamOffset', 'ISpeechAudioFormat',
    'SPEI_SOUND_START', 'SRAORetainAudio', 'eLEXTYPE_RESERVED4',
    'SAFT22kHz8BitStereo', 'DISPID_SOTDataKey', 'DISPID_SLWs_NewEnum',
    'SpeechRegistryLocalMachineRoot', 'SDTDisplayText',
    'SAFTNoAssignedFormat', 'SPEI_MIN_SR', 'SPRECOSTATE',
    'SPAS_PAUSE', 'SPXRO_SML', 'DISPID_SVSpeakStream',
    'SpeechGrammarState', 'SPPS_Function', 'SVP_19',
    ...
    'ISpeechRecoGrammar', 'SPINTERFERENCE_NOISE', 'SRSInactive',
    'DISPID_SGRAddResource', 'SPSHT_OTHER', 'SITooQuiet',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRCResume',
    '__MIDL_IWinTypes_0009', 'SSSPTRelativeToEnd',
    'ISpeechLexiconPronunciation', 'SVSFParseSapi',
    'ISpeechPhraseElements', 'SPSERIALIZEDPHRASE',
    'DISPID_SPIProperties', 'ISpeechFileStream',
    'SGDSActiveUserDelimited', 'eLEXTYPE_PRIVATE12',
    'SPEI_TTS_BOOKMARK', 'SECFEmulateResult',
    'DISPID_SOTGetStorageFileName', 'DISPID_SLWsItem',
    'DISPID_SpeechRecoResult', 'ISpLexicon', 'ISpEventSource',
    'ISpMMSysAudio', 'SPPARTOFSPEECH',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SINoise',
    'ISpResourceManager', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SpeechRecoResultTimes', 'SpInprocRecognizer', 'SVP_12',
    'SPSTREAMFORMATTYPE', 'SpeechTokenKeyUI',
    'DISPID_SVSpeakCompleteEvent',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRCreateRecoContext', 'SAFT11kHz16BitStereo',
    'SpeechAudioFormatType', 'SDA_No_Trailing_Space', 'SRAExport',
    'SREHypothesis', 'DISPID_SRRSpeakAudio',
    'DISPID_SLGetPronunciations', 'ISpeechRecoContext',
    'SAFT48kHz16BitStereo', 'ISpRecoCategory', 'SPSHORTCUTPAIRLIST',
    'SPAUDIOSTATUS', 'SSTTDictation', 'DISPID_SASNonBlockingIO',
    'SPAS_CLOSED', 'eLEXTYPE_PRIVATE15', 'DISPID_SRIsUISupported',
    'DISPID_SPRuleNumberOfElements', 'ISpeechRecoResult2',
    'DISPID_SpeechGrammarRuleState', 'SP_VISEME_16', 'ISpRecoContext',
    'SpeechGrammarTagWildcard', 'SGSEnabled', 'DISPID_SPAsCount',
    'SGDSActiveWithAutoPause', 'DISPID_SPAs_NewEnum', 'ISpShortcut',
    'DISPID_SPPFirstElement', 'SP_VISEME_11', 'SPAUDIOSTATE',
    'SPFM_CREATE', 'SpeechEngineProperties', 'SPRST_ACTIVE',
    'ISpRecognizer2', 'DISPID_SGRsDynamic',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRGetPropertyString',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SABIBufferSize',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPXRO_Alternates_SML',
    'ISpeechBaseStream', 'SVP_17', 'SpeechAddRemoveWord',
    'SpeechUserTraining', 'DISPID_SPARecoResult', 'SRCS_Enabled',
    'SPWF_SRENGINE', 'eLEXTYPE_PRIVATE7', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRSAddSpecialTransition', 'SAFT22kHz16BitStereo',
    'DISPID_SRCRetainedAudio', 'SPTEXTSELECTIONINFO',
    'DISPID_SRGRecoContext', 'eLEXTYPE_PRIVATE20', 'SRESoundStart',
    'SVSFIsFilename', 'DISPID_SPPEngineConfidence', 'UINT_PTR',
    'DISPID_SVPause', 'SAFT8kHz16BitStereo',
    'SWPUnknownWordUnpronounceable', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SPEs_NewEnum', 'SVP_14', 'SPEI_WORD_BOUNDARY',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRCPause',
    'DISPID_SpeechRecoContext', 'DISPID_SRRTimes',
    'DISPID_SPEActualConfidence', 'SPEI_UNDEFINED',
    'DISPID_SVSLastResult', 'SVF_Emphasis', 'DISPID_SOTId',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRRSetTextFeedback',
    'SREBookmark', 'SPPS_Interjection',
    'SpeechGrammarTagUnlimitedDictation', 'SDA_One_Trailing_Space',
    'SPGS_DISABLED', 'SpeechCategoryAudioOut', 'SPFM_OPEN_READWRITE',
    'DISPID_SVRate', 'SITooLoud', 'SP_VISEME_12', 'SPWF_INPUT',
    'SVP_13', 'DISPID_SLPType', 'ISpeechObjectTokens',
    'SPXMLRESULTOPTIONS', 'DISPID_SASFreeBufferSpace',
    'DISPID_SVSyncronousSpeakTimeout', 'SPWT_DISPLAY', 'SSFMCreate',
    'SPCS_ENABLED', 'SLTApp', 'SREAdaptation', 'SGDSInactive',
    'SREAllEvents', 'SAFT44kHz16BitStereo', 'DISPID_SRSAudioStatus',
    'DISPID_SRCERequestUI', 'DISPID_SRRTLength', 'SAFT8kHz8BitStereo',
    'DISPID_SGRSTPropertyId', 'DISPID_SPRFirstElement',
    'DISPID_SLPPartOfSpeech', 'eLEXTYPE_RESERVED10', 'SVP_18',
    'SpeechFormatType', 'DISPID_SGRId', 'DISPID_SLWType',
    'SPAUDIOBUFFERINFO', 'tagSTATSTG', 'SPWORD',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SGRSTType',
    'SpeechDisplayAttributes', 'SpSharedRecoContext',
    'DISPID_SpeechAudioFormat', 'STCLocalServer', 'SPEI_RESERVED1',
    'SITooFast', 'SPSHT_NotOverriden', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechPhraseReplacements', 'SPEI_SR_AUDIO_LEVEL',
    'SPVPRI_ALERT', 'DISPID_SGRSTs_NewEnum', 'SAFT22kHz16BitMono',
    'SGDisplay', 'SPVOICESTATUS', 'SPDATAKEYLOCATION',
    'SPPS_RESERVED4', 'SPFILEMODE', 'DISPID_SPIElements',
    'SPSHT_EMAIL', 'DISPID_SpeechPhraseInfo', 'DISPID_SPPName',
    'DISPID_SLPsCount', 'SPEVENTENUM', 'DISPID_SVGetAudioOutputs',
    'ISequentialStream', 'SAFT48kHz16BitMono',
    'SPINTERFERENCE_TOOQUIET', 'SDTLexicalForm',
    'SPADAPTATIONRELEVANCE', 'DISPID_SLPSymbolic',
    'DISPID_SRGIsPronounceable', 'SP_VISEME_18',
    'DISPID_SRRAudioFormat', 'DISPID_SREmulateRecognition',
    'DISPID_SGRsCount', 'DISPID_SPPParent',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPRules_NewEnum',
    'SpeechRecoEvents', 'ISpRecognizer', 'ISpVoice',
    'DISPID_SRRAudio', 'SpeechEmulationCompareFlags',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPRuleName',
    'DISPID_SRCEPhraseStart', 'ISpeechRecognizer',
    'DISPID_SpeechPhraseRule', 'SWPUnknownWordPronounceable',
    'ISpAudio', 'SpeechRuleAttributes', 'DISPID_SWFEChannels',
    'SP_VISEME_6', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRGDictationLoad', 'SpeechAudioProperties', 'SPSNoun',
    'STSF_AppData', 'SPBO_TIME_UNITS', 'ISpeechGrammarRules',
    'SWTAdded', 'ISpeechVoice', 'DISPID_SBSWrite',
    'DISPID_SVEAudioLevel', 'DISPID_SVGetAudioInputs',
    'SAFT44kHz16BitMono', 'SpeechAudioState', 'SGRSTTWildcard',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRCSetAdaptationData', 'SPPHRASERULE', 'SpShortcut',
    'SpInProcRecoContext', 'SSTTTextBuffer',
    'DISPID_SpeechRecoResult2', 'DISPID_SpeechLexiconWord',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVEStreamStart', 'SAFTADPCM_8kHzMono', 'SDTRule',
    'SPPS_SuppressWord', 'DISPID_SVEWord', 'SPEI_RESERVED2',
    'SGRSTTWord', 'SPEI_START_INPUT_STREAM', 'SREAudioLevel',
    'SSTTWildcard', 'SPDKL_CurrentUser', 'SPEI_SR_RETAINEDAUDIO',
    'SPSModifier', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SVSLastStreamNumberQueued', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpTextSelectionInformation', 'DISPID_SGRSTsCount',
    'SP_VISEME_20', 'SPAS_RUN', 'SRSEDone', 'SP_VISEME_17',
    'DISPID_SRAudioInput', 'DISPID_SRCBookmark',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPAsItem',
    'ISpeechLexiconWord', 'ISpeechPhraseInfoBuilder', 'ISpRecoResult',
    'SREPrivate', 'ISpeechPhraseRule', 'DISPID_SPELexicalForm',
    'SRSInactiveWithPurge', 'SWPKnownWordPronounceable',
    'DISPID_SDKEnumKeys', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SPPs_NewEnum', 'ISpProperties', 'SPPHRASEREPLACEMENT',
    'ISpStreamFormat', 'DISPID_SRCEAdaptation',
    'SpeechCategoryVoices', 'SGRSTTTextBuffer', 'SPWORDPRONOUNCEABLE',
    'SRAONone', 'SDKLLocalMachine', 'SPEI_PHONEME', 'SPAUDIOOPTIONS',
    'SFTSREngine', 'DISPID_SpeechPhraseAlternate',
    'eLEXTYPE_PRIVATE8', 'SPBINARYGRAMMAR',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechDataKeyLocation',
    'SAFTNonStandardFormat'
]

_check_version('1.2.0', 1700102938.502109)
